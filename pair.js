            ...
            Malvin.ev.on("connection.update", async (s) => {
                ...
                if (connection === "open") {
                    ...
                    const sid = megaUrl.includes("https://mega.nz/file/")
                        ? 'dutsva-Ai~' + megaUrl.split("https://mega.nz/file/")[1]
                        : 'Error: Invalid URL';
...
🔗 *Join Our Support Channel:* 👉 [Click Here to Join](https://whatsapp.com/channel/0029Vb6PAolGufJ0QSwCEn1Y) 

⭐ *Show Some Love!* Give us a ⭐ on GitHub and support the developer of: 👉 GitHub Repo  (https://github.com/dutsva2025/)  

🚀 _Thanks for choosing Dutsva Ai — Let the automation begin!_ ✨`;
